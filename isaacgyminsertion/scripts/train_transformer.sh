...
data_folder=/home/roblab20/tactile_dex/datastore_${SEED}_${CACHE}_dex
output_dir=outputs/${CACHE}
path_norm=${data_folder}/normalization.pkl
student_ckpt_path=/home/roblab20/tactile_dex/datastore_${SEED}_${CACHE}_dex/tac+eef/checkpoints/model_2.pt
