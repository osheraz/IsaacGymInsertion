...
class digit_renderer:
    def __init__(
        ...
        # Create renderer
        import os
        bg = cv2.imread(os.path.join(os.path.join(os.path.dirname(__file__), "../"), f"experiments/conf/ref/ref_frame_white15.jpg"))

        self.renderer = tacto.Renderer(
            width=cfg.width,
            height=cfg.height,
            background=None,
            config_path='/home/osher/Desktop/isaacgym/python/IsaacGymUtils/isaacgymutils/allsight/tacto/config_digit.yml',#'#tacto.get_digit_config_path(),
            headless=True,
        )
    ...
    def render(self, object_poses=None):
        """
